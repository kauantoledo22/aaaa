...
for (let i=0; < numHegonos; i++){
    createHexagon();
}

window.addEventListener('resize'){
    const currentethexagons = container.querySelectorAll('hexagons').length;
    const targehexagons = Math.cell((window.innerHeight* wimdow.innerHeight
    ))
